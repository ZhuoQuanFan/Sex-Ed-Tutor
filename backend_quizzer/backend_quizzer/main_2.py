...
def index():
    ...
    if request.method == 'POST':
        ...
        if state == 'Step One Finished' and user_message != "I already understand!":
            ...
            user_message_cleaned = user_message.replace("\n", " ")
            msg[
                'tutor_message'] = "For more details on these terms, you might find this article helpful:<br/>Content + [link1] ………"
            tutor_msg.append(msg)
        ...
        if state == "Step One Finished":
            ...
            msg[
                'tutor_message'] = "Now let‘s start the case study session, Here is an example of the community post:<br/>" \
        ...
        if state == 'Step Two Begins' and user_message == "I didn\'t understand the post":
            ...
            msg['tutor_message'] = search_gpt(
                query) + "<br/>If you still don‘t understand, <b>copy this paragraph</b> and send it to me"
        ...
        if user_message == "Show me comments" or user_message == "Please show me more cases":
            msg = copy.deepcopy(msg_example)
        ...
        if state =='ask questions' and user_message == "I got it!":
            msg = copy.deepcopy(msg_example)
            msg['tutor_message'] = "Yep. "
            msg['options'] = ['Finish case study','Please show me more cases']
            msg['state'] = 'temporarily finished'
            tutor_msg.append(msg)

        if state == 'temporarily finished' and user_message == 'Finish case study':
            msg = copy.deepcopy(msg_example)
            msg['state'] = 'Step 3 Finished'
            msg['tutor_message'] = "Introduction for s3"
            tutor_msg.append(msg)
        ...
        if user_message == 'Finish case study' and (state == 'temporarily finished' or state == 'Show Answer' or state == 'Show Explanation'):
